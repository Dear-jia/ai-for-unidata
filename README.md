...
| 院校分数线记录 | **71,385 条分数线记录**：每所院校均含**工学门类（08 代码）38 个一级学科国家线参考**（力学 0801 … 计算机科学与技术 0812、软件工程 0835、网络空间安全 0839 等 × 2025/2026 两年，照顾专业单列），支持按学校 / 年份 / 专业查询；厦门大学 2025 复试线文本已入库 | 教育部国家线 + 研招网 |

> 平台分数线数据**仅保留 2025、2026 两个年度**，更早年份已清理。**数据真实性说明**：
> 各院校详情页的"国家线"行全部来自教育部公布的全国统一国家线（真实数值，工学门类照顾专业与普通工学分别取值），并在界面明确标注"国家线参考，以官方公布为准"，与各校自己公布的"复试线"严格区分；
> 未收录单独复试线的院校展示工学门类一级学科国家线作为参考，不虚构任何院校数据。
