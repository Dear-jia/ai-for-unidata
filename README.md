...
| 院校分数线记录 | **41,337 条分数线记录**：每所院校均含**全学科门类国家线参考**（哲学 / 经济学 / 法学 / 工学等 44 项 × 2025/2026 两年），支持按学校 / 年份 / 专业查询；厦门大学 2025 复试线文本已入库 | 教育部国家线 + 研招网 |

> 平台分数线数据**仅保留 2025、2026 两个年度**，更早年份已清理。**数据真实性说明**：
> 各院校详情页的"国家线"行全部来自教育部公布的全国统一国家线（真实数值），并在界面明确标注"国家线参考，以官方公布为准"，与各校自己公布的"复试线"严格区分；
> 未收录单独复试线的院校展示全学科国家线作为参考，不虚构任何院校数据。
