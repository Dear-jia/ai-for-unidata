...
| 院校分数线记录 | **1,899 条分数线记录**：每所院校均含**计算机相关学科（工学门类）国家线参考**（2025/2026），支持按学校 / 年份 / 专业查询；厦门大学 2025 复试线文本已入库 | 教育部国家线 + 研招网 |

> 平台分数线数据**仅保留 2025、2026 两个年度**，更早年份已清理；未收录单独复试线的院校，展示计算机相关学科（工学门类）国家线作为参考。
